        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FriendRequests_Users_ReceivedById",
                        column: x => x.ReceivedById,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FriendRequests_Users_SentById",
                        column: x => x.SentById,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Group_UserId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupUsers", x => x.Group_UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FriendRequests_ReceivedById",
                table: "FriendRequests",
                column: "ReceivedById");

            migrationBuilder.CreateIndex(
                name: "IX_FriendRequests_SentById",
                table: "FriendRequests",
                column: "SentById");
